...
<ol class="vasp-step-list">
  <li class="vasp-step-item">
    ...
    <div class="vasp-step-content">
      <div class="vasp-step-title">출금 시나리오 진행을 위해 Robot VASP의 정보를 확인합니다.</div>
    </div>
  </li>
  <li class="vasp-step-item">
    <div class="vasp-step-badge">2</div>
    <div class="vasp-step-content">
      <div class="vasp-step-title">Owner Verification: 사전 검증, 사후 검증 두 가지 케이스의 검증을 진행합니다.</div>
    </div>
  </li>
  <li class="vasp-step-item">
    <div class="vasp-step-badge">3</div>
    <div class="vasp-step-content">
      <div class="vasp-step-title">Report Verification Result: Robot VASP가 검증 결과를 보고합니다.</div>
    </div>
  </li>
  <li class="vasp-step-item">
...
* **조건**
  ...
  * Robot VASP가 귀사의 VASP에게 Owner Verification을 요청합니다. Owner Verification Simulation API를 호출해 Owner Verification을 요청하도록 명령합니다.

  <Accordion title="Owner Verification Simulation API 호출 방법">
    **Method**: `POST`
    ...
    ```
     {
       "supplementary_data": {
           "envelope": {
               ...
               "vasp_id": "15952089931162059995",
               "type": "VerifyBeneficiary",
               "ticker": "ETH",
               "network": "ethereum",
               "address": "0xe6998af38840836d2469ae71aa849f4f94c2b6d6"
           }
       },
       "creditor": {
           "name": "honggildong",
