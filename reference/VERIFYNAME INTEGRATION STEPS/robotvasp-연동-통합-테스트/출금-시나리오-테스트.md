...
<ol class="vasp-step-list">
  ...
  <li class="vasp-step-item">
    ...
    <div class="vasp-step-content">
      <div class="vasp-step-title">Robot VASP가 귀사의 VASP에게 사후 검증을 요청합니다.</div>
    </div>
  </li>
</ol>
`}</HTMLBlock>
...
<Accordion title="My Accordion Title" icon="fa-info-circle">
  ...
  * **Endpoint**: `<Robot Vasp Url>/v1.0/testnet/balance`
  ...
  * **요청 예제**
  ...
  ```json
  https://api.verifyvasp.xyz/vega/robot/v1.0/testnet/balance?vaspId=15952089931162058999&symbol=ETH&address=0xFa230E9cCAF5e382539147294d7965Eeccbbfa5c
  ```
</Accordion>
