...
metadata:
  robots: index
---
VerifyName 프로토콜 연동을 위해, 모든 VASP는 송신자-수신자 검증 API를 비롯한 필수 VASP API들을 구현하여 Enclave가 호출할 수 있도록 제공해야 합니다. 이 섹션에서는 구현 대상 API 목록과 각 API의 명세, 호출 흐름, 구현 시 유의사항 등을 설명합니다.
