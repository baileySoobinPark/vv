...
excerpt: >-
  VerifyVASP의 두 대표 솔루션인 TravelRule과 VerifyName의 기능 차이 및 VASP 요구사항에 따른 구현 권장사항을
  확인할 수 있습니다. 귀사 VASP의 Travel Rule 규제 의무에 따라 적합한 프로토콜을 선택하여 구현하세요. 
deprecated: false
hidden: false
metadata:
  robots: index
...
**TravelRule** 은 Travel Rule **규제 의무가 있는 VASP간** 가상자산 전송 과정에서 송.수신인 개인정보의 안전한 교환 및 상호 검증을 지원합니다. TravelRule을 지원하는 VASP간 송금 시 송신인과 수신인이 같거나 다른 경우 모두 송금이 가능합니다.
