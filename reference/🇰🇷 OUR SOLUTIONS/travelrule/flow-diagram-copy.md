...
Sequence Diagram 1은 TravelRule 기본 프로토콜 구현의 Best Practice를 보여줍니다. TravelRule 프로토콜은 다음과 같은 4개 Phase 로 구성됩니다: **(1) 수신 VASP 선택 (2) 계정 검증 (3) 사용자 검증 (4) 트랜잭션 실행**. Sequence Diagram 1은 점선 박스로 각 단계를 구분하여 표시합니다.
