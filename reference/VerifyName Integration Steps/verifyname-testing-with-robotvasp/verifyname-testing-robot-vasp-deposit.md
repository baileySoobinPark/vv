  ...
  * Your VASP must use the Robot VASP API to request that Robot VASP initiate the virtual asset transfer transaction.
  ...
  <Accordion title="How to use the Robot VASP Withdrawal Request API">
    ...
    * **Request Query**
    ...
    | --------------------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
    | `verification_result` | string | The verification result determined by the VASP that initiated the owner verification request with the VerifyBeneficiary type. <br /><br />  This field will return one of the following values: `VERIFIED`, `DENIED`,` ERROR` | `VERIFIED`                                                         |
    | `tx_hash`             | string | Unique Identifier of transaction. <br /><br />  This field is required when the `verification_result` is `VERIFIED`.                                                                                                          | `8a54d58ca4100112a5430818776d74898f2232770bae03046862575cb851a042` |
    | `vout` (optional)     | string | In cases where multiple transfers can be included in a single transaction, such as Bitcoin, an index value indicating which transfer corresponds to within a single transaction.                                              | `0`                                                                |
    | `reason`              | string | Must be within the available balance verified in withdrawal test 3-1 case 1.                                                                                                                                                  | –                                                                  |
    | `message`             | string | To verify whether the transaction report is submitted after withdrawal. If set to `true`, the transaction result will not be submitted. Your VASP can set this to `true` to conduct test case 2 in 2-1. Default is `false`.   | –                                                                  |
    ...
    * For the VASP who want to conduct the transaction report API test without virtual asset transfer, the Robot VASP provides Transaction Reporting Simulation API.
    ...
    <Accordion title="How to use the Robot VASP Withdrawal Request API">
      ...
      * **Request Query**
      ...
      | Parameter Name               | Type                                                        | Description                                                                                                                                                                                                                                                                                   | Example                                                                                       |                  |
      | ---------------------------- | ----------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ---------------- |
      | `ticker`                     | enum (`VERIFIED`, `DENIED`, `ERROR`)                        | The verification result determined by the VASP that requested owner verification using the `VerifyBeneficiary` type.                                                                                                                                                                          | `VERIFIED`                                                                                    |                  |
      | `originator_account_ number` | string **(required if`verification_result` is `VERIFIED`)** | Unique identifier of the transaction.                                                                                                                                                                                                                                                         | `8a54d58ca4100112a5430818776d74898f2232770bae03046862575cb851a042`                            |                  |
      | `originator_tag`             | string                                                      | In cases where multiple transfers can be included in a single transaction (e.g., Bitcoin), this is the index value that indicates which transfer corresponds to this verification.                                                                                                            | `0`                                                                                           |                  |
      | `reason`                     | string                                                      | This field explains the reason why the result of the owner verification is DENIED or ERROR. <br /><br /> This field is required when the verification result has been reported as DENIED or ERROR by the VASP that initiated the owner verification request using the VerifyBeneficiary type. |                                                                                               |                  |
      | `MISMATCH-TICKER`            | `message`                                                   | string (optional)                                                                                                                                                                                                                                                                             | Detailed message explaining the reason when reporting `DENIED` or `ERROR` alongside `reason`. | `transfer error` |
