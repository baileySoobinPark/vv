  ...
  * Your VASP must use the Robot VASP API to request that Robot VASP initiate the virtual asset transfer transaction.
  ...
  <Accordion title="How to use the Robot VASP Withdrawal Request API">
    ...
    * **Request Query**
    ...
    | -------------------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
    | `verification_result`                  | string  | The verification result determined by the VASP that initiated the owner verification request with the VerifyBeneficiary type. This field will return one of the following values: `VERIFIED`, `DENIED`,` ERROR`             | `VERIFIED`                                   |
