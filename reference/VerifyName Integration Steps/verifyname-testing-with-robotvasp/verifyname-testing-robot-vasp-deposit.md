  ...
  * Your VASP must use the Robot VASP API to request that Robot VASP initiate the virtual asset transfer transaction.
  ...
  <Accordion title="How to use the Robot VASP Withdrawal Request API">
    ...
    * **Request Query**
    ...
    | `tx_hash`                   | string  | Unique Identifier of transaction. <br /><br />  This field is required when the `verification_result` is `VERIFIED`.                                                                                                          | `0xe6998af38840836d2469ae71aa849f4f94c2b6d6` |
    | `vout` (optional)           | string  | Tag used for verification when the address includes a secondary tag (e.g., destination tag, memo).                                                                                                                            | `2852039353`                                 |
